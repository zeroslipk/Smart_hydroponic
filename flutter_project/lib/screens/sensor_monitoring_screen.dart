                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: _buildLiquidSensorCard(sensors[index]),
                      );
                    },
                  ),
                ),
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildStatItem('Min', sensor.min.toString(), sensor.unit),
                Container(width: 1, height: 40, color: Colors.grey[300]),
                _buildStatItem('Avg', sensor.avg.toString(), sensor.unit),
                Container(width: 1, height: 40, color: Colors.grey[300]),
                _buildStatItem('Max', sensor.max.toString(), sensor.unit),
              ],
            ),
          ),
